...
{
	/// <summary>
	/// This class provides a skeletal implementation of the <c>IFileDetails</c>interface to minimize the effort 
	/// required to implement the interface.
	/// <seealso cref="IFileDetails"/>
	/// </summary>
	public abstract class AbstractFileDetails
		: AbstractNodeDetails, IFileDetails
	{		
