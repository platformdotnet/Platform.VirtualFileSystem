...
namespace Platform.VirtualFileSystem.Providers.Local
{
		...
		: AbstractNodeDetails
	{
		...
		public override DateTime CreationTime
		{
			get
			{
				return m_FsInfo.CreationTime;
			}
			set
			{
				m_FsInfo.CreationTime = value;
			}
		}
		...
		public override DateTime LastAccessTime
		{
			get
			{
				return m_FsInfo.LastAccessTime;
			}
			set
			{
				m_FsInfo.LastAccessTime = value;
			}
		}
		...
		public override DateTime LastWriteTime
		{
			get
			{
				return m_FsInfo.LastWriteTime;
			}
			set
			{
				m_FsInfo.LastWriteTime = value;
			}
		}
