...
namespace ICSharpCode.SharpZipLib.Zip.Compression.Streams.Interactive
{
	...
	/// </remarks>
	public class InteractiveInflaterInputBuffer
	{
		/// <summary>
		/// Initialise a new instance of <see cref="InflaterInputBuffer"/>
		/// </summary>
		/// <param name="stream">The stream to buffer.</param>
		public InteractiveInflaterInputBuffer(Stream stream, int bufferSize)
		{
			inputStream = stream;
	...
	/// </summary>
	public class InteractiveInflaterInputStream : Stream
	{
		/// <summary>
		...
		/// </summary>
		protected InteractiveInflaterInputBuffer inputBuffer;
		...
		/// </param>
		public InteractiveInflaterInputStream(Stream baseInputStream)
		...
		/// </param>
		public InteractiveInflaterInputStream(Stream baseInputStream, Inflater inf)
